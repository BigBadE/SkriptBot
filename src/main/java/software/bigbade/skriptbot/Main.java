...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    registerCommands();
    SkriptBot skriptBot =
        new SkriptBot(arguments, commandManager.getCommands());
    try {
      skriptBot.init();
  ...
  private static void registerCommands() {
    ResourceDataFetcher dataFetcher =
        new ResourceDataFetcher(arguments.getSkUnityKey());
    commandManager.registerCommand(
        new AddonSearchCommand(dataFetcher, arguments.getPrefix()));
    commandManager.registerCommand(
        new DocSearchCommand(dataFetcher, arguments.getPrefix()));
    commandManager.registerCommand(
        new PastebinCommand(arguments.getPastebinKey(), arguments.getPrefix()));
