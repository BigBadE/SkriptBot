...
public class AddonSearchCommand implements ICommand {
    ...
    public void onCommand(Member sender, TextChannel channel, String id, String[] args) {
        ...
        MessageUtils.sendEmbedWithReaction(channel, new EmbedBuilder()
                .setTitle(data.getString(JsonKeys.PLUGIN.getKey()) + " " + data.getString(JsonKeys.VERSION.getKey()), data.getString(JsonKeys.DOWNLOAD.getKey()))
                ...
                .addField("Download (" + humanReadableByteCountSI(data.getLong(JsonKeys.BYTES.getKey())) + ")", data.getString(JsonKeys.DOWNLOAD.getKey()), false)
