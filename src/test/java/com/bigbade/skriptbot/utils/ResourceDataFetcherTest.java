...
import com.bigbade.skriptbot.SkriptBot;
...
class ResourceDataFetcherTest {
    ...
    static void setupDataFetcher() {
        ...
        //Prevent intentional errors getting logged
        SkriptBot.getLogger().setLevel(Level.OFF);
    }

    @AfterAll
    static void afterAll() {
        SkriptBot.getLogger().setLevel(Level.FINEST);
    }
